...
tpot_data = pd.read_csv('C:/Users/Lenovo\Desktop/COFS-CO2CH4/ExtendedSheets/CH4 - 10 BAR.csv', sep=',', dtype=np.float64)
...
with open("Models/model_CH4-10BAR.pkl", "wb") as f:
