...
tpot_data = pd.read_csv('C:/Users/Lenovo\Desktop/COFS-CO2CH4/ExtendedSheets/CO2 - 1 BAR - 393 K.csv', sep=',', dtype=np.float64)
...
with open("Models/model_CO2-1BAR-393K.pkl", "wb") as f:
